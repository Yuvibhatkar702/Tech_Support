...
const resources = {
  en: {
    translation: {
      ...
      track_placeholder: 'e.g., GRV2603020001',
      track_button: 'Track',
      ...
      // Tracking Tabs
      tab_complaint_id: 'Complaint ID',
      tab_mobile_number: 'Mobile Number',
      ...
      otp_sent_hint: 'Enter the 6-digit OTP sent to your number',
      otp_invalid: 'Invalid OTP',
      otp_expired: 'OTP has expired. Please request a new one.',
      otp_resend: 'Resend OTP',
      otp_resend_in: 'Resend OTP in',
      no_complaints_for_number: 'No complaints found for this phone number',
      your_complaints: 'Your Complaints',
      total_found: 'complaints found',
      view_details: 'View Details',
      back_to_search: 'Back to Search',
      mobile_tracking_instruction: 'Enter your mobile number to view all complaints linked to it',
  ...
  hi: {
    translation: {
      ...
      // Tracking Tabs
      tab_complaint_id: 'शिकायत आईडी',
      tab_mobile_number: 'मोबाइल नंबर',
      ...
      otp_sent_hint: 'अपने नंबर पर भेजा गया 6-अंकों का OTP दर्ज करें',
      otp_invalid: 'गलत OTP',
      otp_expired: 'OTP की समय सीमा समाप्त हो गई। कृपया नया अनुरोध करें।',
      otp_resend: 'OTP पुनः भेजें',
      otp_resend_in: 'OTP पुनः भेजें',
      no_complaints_for_number: 'इस फोन नंबर के लिए कोई शिकायत नहीं मिली',
      your_complaints: 'आपकी शिकायतें',
      total_found: 'शिकायतें मिलीं',
      view_details: 'विवरण देखें',
      back_to_search: 'खोज पर वापस जाएं',
      mobile_tracking_instruction: 'अपने सभी शिकायतें देखने के लिए अपना मोबाइल नंबर दर्ज करें',
  ...
  mr: {
    translation: {
      ...
      otp_sent: 'तुमच्या मोबाइल नंबरवर OTP पाठवला',
      otp_sent_hint: 'तुमच्या नंबरवर पाठवलेला 6-अंकी OTP प्रविष्ट करा',
      otp_invalid: 'चुकीचा OTP',
      otp_expired: 'OTP कालबाह्य झाला. कृपया नवीन विनंती करा.',
      otp_resend: 'OTP पुन्हा पाठवा',
      otp_resend_in: 'OTP पुन्हा पाठवा',
      no_complaints_for_number: 'या फोन नंबरसाठी कोणतीही तक्रार सापडली नाही',
      your_complaints: 'तुमच्या तक्रारी',
      total_found: 'तक्रारी सापडल्या',
      view_details: 'तपशील पहा',
      back_to_search: 'शोधाकडे परत',
      mobile_tracking_instruction: 'तुमच्या सर्व तक्रारी पाहण्यासाठी तुमचा मोबाइल नंबर प्रविष्ट करा',
